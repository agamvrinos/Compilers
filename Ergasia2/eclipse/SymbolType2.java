...
public class SymbolType2 {
	...
	SymbolType2(String kind, String name, String type){	// simple var
		this.kind = kind;
		this.name = name;
		this.type = type;
		parameters = null;
	...
	SymbolType2(String kind, String name, String type, ArrayList<String> arg){	// method
		this.kind = kind;
		this.name = name;
		this.type = type;
