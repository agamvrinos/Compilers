...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        FileInputStream fis = new FileInputStream(projectDirectory + "/Inputs/Spiglet/Factorial.spg");
         ...
         */
        final File factsDirectory = new File("/home/agg/Desktop/github/Compilers/3.Optimization/iris-example-master/facts");
