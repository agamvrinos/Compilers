...
//			buffer += "\t=================== Vtable Creation ====================\n";
    ...
    */
    ...
    public DataBlock visit(ClassExtendsDeclaration n, DataBlock argu) {
    	...
    	String extended_name = answer_db.name;
...
//		buffer += "\t=====================================================\n";
     ...
     */
    public DataBlock visit(FormalParameterList n, DataBlock argu) {
    	DataBlock _ret=null;
       n.f0.accept(this, argu);
       n.f1.accept(this, argu);
       return _ret;
     ...
     */
    public DataBlock visit(FormalParameterTail n, DataBlock argu) {
     ...
     * f1 -> FormalParameter()
     */
    public DataBlock visit(FormalParameterTerm n, DataBlock argu) {
    	DataBlock _ret=null;
       n.f0.accept(this, argu);
       n.f1.accept(this, argu);
       return _ret;
     ...
     *       | Identifier()
     */
    public DataBlock visit(Type n, DataBlock argu) {
       return n.f0.accept(this, argu);
    }
     ...
     * f2 -> "]"
     */
    public DataBlock visit(ArrayType n, DataBlock argu) {
    	DataBlock _ret=null;
       n.f0.accept(this, argu);
       n.f1.accept(this, argu);
       n.f2.accept(this, argu);
     ...
     * f0 -> "boolean"
     */
    public DataBlock visit(BooleanType n, DataBlock argu) {
       return n.f0.accept(this, argu);
    }
     ...
     * f0 -> "int"
     */
    public DataBlock visit(IntegerType n, DataBlock argu) {
       return n.f0.accept(this, argu);
    }
     ...
     * f2 -> "}"
     */
    public DataBlock visit(Block n, DataBlock argu) {
    	DataBlock _ret=null;
       n.f0.accept(this, argu);
       n.f1.accept(this, argu);
       n.f2.accept(this, argu);
...
//		if (Utils.symbolTables.get(current_class).fieldCheck(var_name) == null){
    ...
    public DataBlock visit(ArrayAssignmentStatement n, DataBlock argu) {
    	...
    	//TODO: ALLAGH INDEX TO LOOK GAMW TIN PANAGAIA
...
//        String copy = Utils.getTemp();
    	...
    	if (method_offset == null){
    		System.out.println("XA0XA00XA0XA0XA0XA");
...
//    	buffer += "\tHLOAD " + v_temp + " " + copy + " 0\n";
     ...
     * f0 -> ( ExpressionTerm() )*
     */
    public DataBlock visit(ExpressionTail n, DataBlock argu) {
       return n.f0.accept(this, argu);
    }
     ...
     *       | PrimaryExpression()
     */
    public DataBlock visit(Clause n, DataBlock argu) {
       return n.f0.accept(this, argu);
    }
...
//    	buffer += "\t================= BOOLEAN ====================\n";
    ...
    public DataBlock visit(Identifier n, DataBlock argu) {
    	...
    	System.out.println("CURENT CLASS: " + current_class);
    	...
    	if (argu != null && (argu.getFlag())){
    		...
    		if (method == null){
    			...
    			System.out.println(method.getName() + " xa99xa9xa9a9xa99ax");
...
//    	buffer += "\tMOVE " + FINAL_arr_address + " " + arr_address + "\n" ;	// keep start address
